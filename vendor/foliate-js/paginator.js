...
export class Paginator extends HTMLElement {
    ...
    #onTouchStart(e) {
        // Petal Reader local patch: swipe navigation is opt-in so iOS text
        // selection handles cannot be mistaken for a page swipe.
    ...
    #onTouchMove(e) {
        if (!this.hasAttribute('swipe') || !this.#touchState) return
